...
def get_vllm_embedding_adaptiv(self, data):
    ...
    self.adaptiv.prepare(num_frames, patch_height, patch_width, frame_stride, height_stride, width_stride, image_token_start_index, image_token_end_index, image_token_length, original_length)
