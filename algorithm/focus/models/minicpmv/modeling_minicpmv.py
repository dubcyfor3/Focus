...
def get_vllm_embedding(self, data):
    ...
    original_length = vllm_embedding[0].shape[0]
    ...
    self.focus.prepare(patch_type, num_frames, patch_height, patch_width, frame_stride, height_stride, width_stride, image_token_start_index, image_token_end_index, image_token_length, original_length)
